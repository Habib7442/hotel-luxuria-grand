      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12">
          <div className="flex flex-col items-center text-center group cursor-default">
            ...
            <p className="font-jakarta font-bold text-xs uppercase tracking-[0.4em] text-champagne/90">Location</p>
          ...
          <div className="flex flex-col items-center text-center group cursor-default">
            ...
            <p className="font-jakarta font-bold text-xs uppercase tracking-[0.4em] text-champagne/90">Rating</p>
          ...
          <div className="flex flex-col items-center text-center group cursor-default">
            ...
            <p className="font-jakarta font-bold text-xs uppercase tracking-[0.4em] text-champagne/90">Experience</p>
